...
同樣全部由 AI 完成:九幕各自的配樂、旁白解說(男聲女聲可切換)、
同步字幕,還有戰鼓、馬蹄、箭雨、刀劍、鐵索、火船爆燃、風與火場的環境音。

配樂不是 AI 憑空生成,是它自己寫管線去 Freesound 撈 CC0 素材,
先讓另一個 AI「代聽」評分(樂器、節奏、有無人聲、時代違和都會回報,
連「結尾有人喊一聲所以不能 loop」都聽得出來),入圍後我再用耳朵終審。
88 首裡選出 11 首。

選曲記錄全程公開,可以看到 AI 怎麼聽音樂:
https://yazelin.github.io/red-cliffs-3d/audition.html

有聲版(建議電腦開、開聲音):
https://yazelin.github.io/red-cliffs-3d/

原本的無聲版凍結保存在這,當作第一輪實驗的原版:
https://yazelin.github.io/red-cliffs-3d/classic.html

旁白的破音字之戰也值得一提:TTS 把「程普率三萬」唸成「律三萬」、
「北還」唸成「北孩」,解法是餵 TTS 同音字「帥三萬」「北環」,
字幕照樣顯示正確的字。這些錯都是人耳和 AI 聽寫各抓到一半。
```
